...
/**
 * WorkAreaDetailsFixture
 */
class WorkAreaDetailsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'work_area_details_ibfk_1' => ['type' => 'foreign', 'columns' => ['work_area_id'], 'references' => ['work_areas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'work_area_id' => 1,
                'status' => 1,
                'created' => '2024-08-24 21:43:59',
                'modified' => '2024-08-24 21:43:59',
            ],
        ];
        parent::init();
    }
